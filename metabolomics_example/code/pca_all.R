...
# Call in map file
map <- read_csv("metabolomics_example/raw_data/File_map.csv") %>% 
...
features <- read_tsv("metabolomics_example/raw_data/ComBat_mzcalibrated_untargeted_averaged_featuretable.txt") %>% 
...
feature.all.label %>% 
    ...
    write_tsv("metabolomics_example/results/features_labels_transposed.txt")
